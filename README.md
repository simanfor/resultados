...
* :bar_chart: **Qpyrenaica_masas_irregulares**: resultados obtenidos para parcelas de *Quercus pyrenaica* de Castilla y León simuladas para el proyecto [Life Rebollo](https://liferebollo.es/) bajo distintos tipos de selvicultura orientada a conseguir y manejar masas irregulares.
