...
🇬🇧 *[English version here](https://github.com/simanfor/resultados/blob/main/english/)*
...
Este repositorio está enfocado en conocer qué resultados se obtienen de las simulaciones y cómo interpretarlos y analizarlos para sacarles el mayor provecho.
...
:floppy_disk: :books: Repositorios asociados a publicaciones:
...
* :books: [Repositorio con simulaciones de masas mixtas de *Pinus sylvestris* y *Pinus pinaster*](https://github.com/aitorvv/Pinus_sylvestris_and_pinaster-trade_offs_and_ecosystem_services) para Pinar Grande (Soria), evaluando la multifuncionalidad selvícola para el artículo científico titulado **Trade-Offs and Management Strategies for Ecosystem Services in Mixed Scots Pine and Maritime Pine Forests**
