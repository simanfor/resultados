...
general_dir <- "escribe aquí la ruta que haga referencia a donde tienes almacenados los resultados, SIN COMAS, ESPACIOS NI SÍMBOLOS; cambia las \ por /" # ejemplo: general_dir <- "C:/Users/pepito/Desktop"

# si lo deseas, también puedes utilizar datos de ejemplo. Descarga este repositorio en tu ordenador (https://github.com/simanfor/resultados), descomprime el archivo y escribe la ruta correcta
